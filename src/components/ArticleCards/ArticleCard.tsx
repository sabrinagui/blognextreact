    ...
    <div className={"w-full lg:w-1/3 md:w-1/2 md:px-[15px] px-2 mb-[30px]"}>
      <LinkTo
        ...
        className={combineClasses(
          ...
          "border-b-[5px]border border-purple-800 dark:bg-slate-800 dark:text-white dark:drop-shadow-lg flex flex-col justify-between"
        )}
      >
        <div>
          ...
          <div className={"d-block px-[15px] py-0"}>
            ...
            <LinkTo href={transformPath(path)} passHref>
              <h1
                className={
                  "text-[22px] font-bold cursor-pointer tracking-wide hover:text-purple-800"
                }
              >
