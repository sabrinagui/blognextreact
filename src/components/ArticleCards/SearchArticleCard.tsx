...
const SerachArticleCard = ({ article, path }: { article: IArticleHeaderData, path: string }) => (
  <div className="w-full lg:w-1/3 md:w-1/2 px-3 mb-10">
    <LinkTo href={path} passHref={true}>
      <div className={combineClasses(classes.article_card, "px-[15px] py-[10px] border-b-[5px] border-purple-800 dark:bg-slate-800 dark:text-white bg-white text-black drop-shadow-lg")}>
